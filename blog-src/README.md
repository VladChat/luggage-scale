...
├─ themes/
│  └─ PaperMod/   ← Hugo theme (clone into this folder)
...
## Add the PaperMod theme (one-time)
Use shallow clone (recommended):
```bash
git clone --depth=1 https://github.com/adityatelange/hugo-PaperMod.git blog-src/themes/PaperMod
```
