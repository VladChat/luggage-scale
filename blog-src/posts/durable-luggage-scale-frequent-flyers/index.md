...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 240" role="img" aria-label="Handheld durable luggage scale">
  ...
  <rect x="20" y="20" rx="16" ry="16" width="300" height="100" fill="#ffffff" stroke="#0F172A" stroke-width="2"/>
  <rect x="36" y="40" rx="8" ry="8" width="160" height="40" fill="#E0E7FF" stroke="#111827"/>
  <text x="46" y="66" font-size="18" font-family="system-ui" fill="#111827">0.0 lb</text>
  <rect x="210" y="40" rx="8" ry="8" width="80" height="40" fill="#2563EB" stroke="#0F172A"/>
  <text x="250" y="66" text-anchor="middle" font-size="16" font-weight="600" font-family="system-ui" fill="#fff">TARE</text>
...
5. **Display**: the LCD/LED shows a final weight in lb/kg; a **TARE** function subtracts accessories like packing cubes or straps.
...
| Feature                    | Durable Luggage Scale                         | Typical Low-Cost Scale                     |
|---------------------------|-----------------------------------------------|-------------------------------------------|
| Hook/Strap Hardware       | Stainless hook or reinforced strap             | Thin alloy hook; weak stitching           |
| Body Material             | Rigid housing with shock-resistant geometry    | Thin plastic shell                         |
| Display                   | High-contrast digits; hold/lock available      | Dim display; no hold; hard to read         |
| Power/Readiness           | Reliable power; quick wake or battery-free     | Battery drain; slow wake                   |
...
**Multi-city itineraries**: Reweigh after gift purchases or conference swag; shifting weight between bags can avoid fees.  
...
- **Protect the display**: store the scale screen-inward or in a soft pouch to prevent scratches.  
- **Know your allowance**: different fare classes and carriers vary; a quick check saves time at the counter.
...
Look for **reinforced housing**, **metal hook/strap hardware**, and buttons that feel solid. A tough scale should handle being tossed into a backpack or pressed in an overhead bin.

**Can I use it for backpacks and duffels?**  
Yes. For soft handles, a strap often grips better than a hook. Lift until the bag is fully off the ground for a stable reading.

**Should I weigh at the airport or hotel?**  
Hotel first. That way you adjust before leaving. If you buy souvenirs, re-check at the airport curb or lobby and shift items to carry-on if needed.

## Final Checklist (Buy Once, Fly Often)
- **Body & hardware:** Reinforced housing, metal hook/strap, solid buttons.  
- **Display:** High-contrast digits, hold/lock, easy unit toggle.  
- **Accuracy:** Consistent repeated readings; stays stable over time.  
- **Size/weight:** Compact and truly packable for weekly use.  
